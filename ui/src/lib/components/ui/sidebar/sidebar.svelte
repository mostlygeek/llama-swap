...
{:else}
	<div
		...
		data-resizing={sidebar.resizing}
	...
	>
		...
		<div
			...
			class={cn(
				"transition-[width] duration-200 ease-linear relative w-(--sidebar-width) bg-transparent group-data-[resizing=true]:transition-none",
		...
		<div
			...
			class={cn(
				"fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex group-data-[resizing=true]:transition-none",
				side === "left"
