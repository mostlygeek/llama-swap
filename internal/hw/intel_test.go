...
func TestHardware_IntelGPUDiscreteWithModel(t *testing.T) {
...
func TestHardware_IntelGPUBattlemageArchOnly(t *testing.T) {
...
func TestHardware_IntelGPUAlchemistDG2(t *testing.T) {
...
func TestHardware_IntelGPUIntegrated(t *testing.T) {
...
func TestHardware_IntelGPUUnknown(t *testing.T) {
