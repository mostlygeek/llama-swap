// The Docs Agent's system prompt. Ported from lib/prompts/docsAgent.ts.
// This is the single tuning surface that needs no server restart: it is sent by
// the client on every request. Keep it consistent by hand with
// internal/server/apimcp.go's mcpInstructions.
export const DOCS_AGENT_SYSTEM_PROMPT = ` * Measure before and after with:
