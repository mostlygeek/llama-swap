...
func TestProcess_AutomaticallyStartsUpstream(t *testing.T) {
	...
	// Create a process
	process := NewProcess("test-process", 5, 1000, config, debugLogger, debugLogger)
	defer process.Stop()
...
func TestProcess_BrokenModelConfig(t *testing.T) {
	...
	process := NewProcess("broken", 1, 1000, config, debugLogger, debugLogger)
...
func TestProcess_UnloadAfterTTL(t *testing.T) {
	...
	process := NewProcess("ttl_test", 2, 1000, config, debugLogger, debugLogger)
	defer process.Stop()
...
func TestProcess_LowTTLValue(t *testing.T) {
	...
	process := NewProcess("ttl", 2, 1000, config, debugLogger, debugLogger)
	defer process.Stop()
...
func TestProcess_HTTPRequestsHaveTimeToFinish(t *testing.T) {
	...
	config := getTestSimpleResponderConfig(expectedMessage)
	process := NewProcess("t", 10, 1000, config, debugLogger, debugLogger)
	defer process.Stop()
...
func TestProcess_SwapState(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			p := NewProcess("test", 10, 1000, getTestSimpleResponderConfig("test"), debugLogger, debugLogger)
...
func TestProcess_ShutdownInterruptsHealthCheck(t *testing.T) {
	...
	process := NewProcess("test-process", healthCheckTTLSeconds, 1000, config, debugLogger, debugLogger)
...
func TestProcess_ExitInterruptsHealthCheck(t *testing.T) {
	...
	process := NewProcess("sleepy", checkHealthTimeout, 1000, config, debugLogger, debugLogger)
...
func TestProcess_StopImmediately(t *testing.T) {
	...
	process := NewProcess("stop_immediate", 2, 1000, config, debugLogger, debugLogger)
	defer process.Stop()
...
func TestProcess_StopCmd(t *testing.T) {
	...
	process := NewProcess("testStopCmd", 2, 1000, config, debugLogger, debugLogger)
	defer process.Stop()
...
func TestProcess_EnvironmentSetCorrectly(t *testing.T) {
	...
	process1 := NewProcess("env_test", 2, 1000, config, debugLogger, debugLogger)
	process2 := NewProcess("env_test", 2, 1000, configWEnv, debugLogger, debugLogger)
