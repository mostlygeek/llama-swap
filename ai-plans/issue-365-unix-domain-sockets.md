...
- add a Config.SocketPath (`socketPath`) , which has a sensible cross platform default
...
- a domain socket path and file name should:
  ...
  - be based on the model name, eg: "my_model" becomes "Config.SocketPath/my_model.sock". Model names can contain invalid path characters. These should be replaced with safe ones like "-"
